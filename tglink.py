...
@piyushlink.on_message(filters.command('start') & filters.private)
...
☂️ | [About Piyush](https://t.me/PiyushMalviyaOfficially)
            """
    await piyushlink.send_message(message.chat.id, text, disable_web_page_preview=True)
    

@piyushlink.on_message(filters.media & filters.private)
...
@piyushlink.on_message(filters.command('tl'))
